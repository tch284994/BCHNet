...
class DatasetVerse2D_Sagittal(Dataset):  # task1 (Axial):num=248, task2 (Sagittal):num=126
    def __init__(self, datapath, fold, transform, split, shot, num=126):
        self.split = split
        self.nclass = 1
        self.benchmark = 'verse2D_sagittal'
        self.shot = shot
        self.num = num

        self.base_path = os.path.join(datapath, 'Verse2D/2')  # task2: Sagittal Plane
