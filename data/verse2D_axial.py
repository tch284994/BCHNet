...
class DatasetVerse2D_Axial(Dataset):  # task1 (Axial):num=248, task2 (Sagittal):num=126
    def __init__(self, datapath, fold, transform, split, shot, num=248):
        self.split = split
        self.nclass = 1
        self.benchmark = 'verse2D_axial'
        self.shot = shot
        self.num = num

        self.base_path = os.path.join(datapath, 'Verse2D/1')
