...
class Visualizer:
    ...
    @classmethod
    def initialize(cls, visualize, benchmark, nshot):
        ...
        # cls.vis_path = './vis/rpt/'
        current_time = datetime.datetime.now()
        formatted_time = current_time.strftime("%Y_%m%d%H%M%S")
        path = './vis/' + formatted_time + '_' + cls.nshot + 'shot_' + cls.benchmark + '/'
